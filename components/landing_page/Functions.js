            ...
            <div className="justify-center row">
                <div className="w-full lg:w-2/3">
                    <div className="pb-10 text-center section-title">
                        ...
                        <h3 className="title">Vyberte, čo chcete naceniť. <span> Informácie, ktoré sa nám z projektov nepodaria vyčítať, doplníte vy </span></h3>
                    </div> 
                </div>
            </div> 
            <div className="justify-center row">
                <FunctionsDiv title={"Základová doska"} image={Zaklady.src} co={"základovej dosky"} project={"pôdorys základov"} toSend={setZaklady}/>
                <FunctionDiv_p title={"Murivo"} image={Murivo.src} co={"muriva"} project={"všetky pôdorysy NP"} toSend={setPodorysy}/>
                <FunctionsDiv title={"Strecha"} image={Strecha.src} co={"strechy"} project={"pôdorys strechy"} toSend={setStrecha}/>
            </div>


            { (zakaldyPdf || podorysyPdf.length || strechaPdf) && <div className="absolute right-0 hidden mt-2 pt-6 mr-24 navbar-btn sm:inline-block lg:mt-0 lg:static lg:mr-0">
                <button className="main-btn font-bold" rel="nofollow" onClick={handleClick}> Vytvoriť cenovú ponuku </button>
            </div> }

            { !(zakaldyPdf || podorysyPdf.length || strechaPdf) && <div className="absolute right-0 hidden mt-2 pt-6 mr-24 navbar-btn sm:inline-block lg:mt-0 lg:static lg:mr-0">
                <button className="main-btn font-bold opacity-50 cursor-auto" rel="nofollow"> Vytvoriť cenovú ponuku </button>
            </div> }
